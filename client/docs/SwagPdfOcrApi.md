...
------------- | ------------- | -------------
[**pdfOcrGetAsyncJobStatus**](SwagPdfOcrApi.md#pdfOcrGetAsyncJobStatus) | **GET** /ocr/pdf/get-job-status | Returns the result of the Async Job - possible states can be STARTED or COMPLETED
[**pdfOcrPdfToLinesWithLocation**](SwagPdfOcrApi.md#pdfOcrPdfToLinesWithLocation) | **POST** /ocr/pdf/to/lines-with-location | Convert a PDF into text lines with location
[**pdfOcrPdfToWordsWithLocation**](SwagPdfOcrApi.md#pdfOcrPdfToWordsWithLocation) | **POST** /ocr/pdf/to/words-with-location | Convert a PDF into words with location
[**pdfOcrPost**](SwagPdfOcrApi.md#pdfOcrPost) | **POST** /ocr/pdf/toText | Converts an uploaded PDF file into text via Optical Character Recognition.


<a name="pdfOcrGetAsyncJobStatus"></a>
# **pdfOcrGetAsyncJobStatus**
> SwagPdfToTextResponse pdfOcrGetAsyncJobStatus(asyncJobID)
...
try {
    // cross your fingers
    SwagPdfToTextResponse result = api.pdfOcrGetAsyncJobStatus(params);
    System.debug(result);
...
[**SwagPdfToTextResponse**](SwagPdfToTextResponse.md)
...
> SwagPdfToLinesWithLocationResult pdfOcrPdfToLinesWithLocation(imageFile, language, preprocessing)
...
try {
    // cross your fingers
    SwagPdfToLinesWithLocationResult result = api.pdfOcrPdfToLinesWithLocation(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **imageFile** | **Blob**| PDF file to perform OCR on. |
...
[**SwagPdfToLinesWithLocationResult**](SwagPdfToLinesWithLocationResult.md)
...
> SwagPdfToWordsWithLocationResult pdfOcrPdfToWordsWithLocation(imageFile, language, preprocessing)
...
try {
    // cross your fingers
    SwagPdfToWordsWithLocationResult result = api.pdfOcrPdfToWordsWithLocation(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagPdfToWordsWithLocationResult**](SwagPdfToWordsWithLocationResult.md)
...
<a name="pdfOcrPost"></a>
# **pdfOcrPost**
> SwagPdfToTextResponse pdfOcrPost(imageFile, recognitionMode, language, preprocessing)
